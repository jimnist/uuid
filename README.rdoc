...
The ngn33r fork of uuid adds another format, the <tt>:teenie</tt> format
...
uuid is forked from UUID available here: http://github.com/assaf/uuid

Source code and documentation hosted on Github: http://github.com/ngn33r/uuid
